...
= 3.0 =
* Enhancement: Complete code rewrite, uses PHP DOM directly for faster processing; Sandbox to test and debug. Deprecation: Dropped `removetags`. Changes: Changes in arguments